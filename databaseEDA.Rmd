...
## Introduction
```{r setupEnvironment, echo=FALSE, warning=FALSE, cache=FALSE, message=FALSE}
...
tableData <- initializePercentMissingDataTable(dataStatistics)
```
- Results suggest `r sum(tableData[,2] > maximumPercentMissing)` variables
exceed the maximum percentage of missing data threshold of
