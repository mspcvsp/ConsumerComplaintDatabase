...
- Estimated monthly occurence of consumer complaints  
```{r complaintFrequency, echo=FALSE}
library(ggplot2)
library(scales)
...
```{r mortgatePercentage, echo=FALSE}
...
```
- Percentage of mortgage category consumer complaints for each U.S. state 
...
## Percentage of Mortgage Category Complaints  
```{r vizTopFiveTexasIssueCategories, echo=FALSE, message=FALSE}
library(ggmap)
if (is.na(file.info(file.path(analyticDataPath,
...
- Percentage of debt collection category consumer complaints for each U.S. state  
...
- Percentage of credit category consumer complaints for each U.S. state  
  
```{r creditPercentage, echo=FALSE}
...
- Percentage of banking category consumer complaints for each U.S. state  
  
```{r bankingPercentage, echo=FALSE}
