...
ohioIssueCategoryPercentage$percentageRange <-
    cut(ohioIssueCategoryPercentage$percentage,
        seq(0,100,by=12.5))

ohioIssueCategoryPercentage$fraction <-
    ohioIssueCategoryPercentage$percentage / 100.0

# http://rprogramming.net/aggregate-data-in-r-using-data-table/
ohioIssueCategoryPercentage <- data.table(ohioIssueCategoryPercentage)
setkey(ohioIssueCategoryPercentage, issuecateogry)

# http://www.statmethods.net/management/sorting.html
weightedSum <- ohioIssueCategoryPercentage[,sum(fraction),by=issuecateogry]
...
ohioIssueCategoryPercentage <- data.frame(ohioIssueCategoryPercentage)

isTopFive <- ohioIssueCategoryPercentage$issuecateogry %in% 
             topFiveCategories

topFiveOhioIssueCategories <- ohioIssueCategoryPercentage[isTopFive,] 
